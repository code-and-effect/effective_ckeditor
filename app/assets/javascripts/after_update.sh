...
for i in ./ckeditor/skins/moonocolor/*.css; do
  ...
  replace="url(<%= asset_path('ckeditor\\/skins\\/moonocolor\\/images\\/arrow.png') %>)"
  sed -i '' -e "s/${search}/${replace}/g" "${i}.erb"

  # Close.png
  search="url(images\\/close.png)"
  replace="url(<%= asset_path('ckeditor\\/skins\\/moonocolor\\/images\\/close.png') %>)"
  sed -i '' -e "s/${search}/${replace}/g" "${i}.erb"
  ...
  replace="url(<%= asset_path('ckeditor\\/skins\\/moonocolor\\/images\\/hidpi\\/close.png') %>)"
  sed -i '' -e "s/${search}/${replace}/g" "${i}.erb"

  # Lock-open.png
  search="url(images\\/hidpi\\/lock-open.png)"
  replace="url(<%= asset_path('ckeditor\\/skins\\/moonocolor\\/images\\/hidpi\\/lock-open.png') %>)"
  sed -i '' -e "s/${search}/${replace}/g" "${i}.erb"

  # lock.png
  search="url(images\\/hidpi\\/lock.png)"
  replace="url(<%= asset_path('ckeditor\\/skins\\/moonocolor\\/images\\/hidpi\\/lock.png') %>)"
  sed -i '' -e "s/${search}/${replace}/g" "${i}.erb"
